...
export const MESSAGES: Record<Locale, Dictionary> = {
  "en-US": {
    ...
    "library.tagCreate": "Add tag",
    "library.tagInputPlaceholder": "Custom tag",
    "library.tagRemove": "Remove tag",
    "library.tagSuggestions": "Add preset tags",
  ...
  "zh-CN": {
    ...
    "library.tagCreate": "添加标签",
    "library.tagInputPlaceholder": "自定义标签",
    "library.tagRemove": "移除标签",
    "library.tagSuggestions": "可添加的预设",
